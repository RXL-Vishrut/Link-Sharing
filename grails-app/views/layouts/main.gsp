...
<nav class="navbar navbar-dark bg-dark navbar-expand-lg" id="navbar">
    ...
    <div class="col-lg-5 menuItem" id="menu" style="max-width: fit-content;display: inline-flex">

        %{--            <---------------------------------NAVBAR TOPIC---------------------------->--}%
        <button class="btn nav-link" data-toggle="modal" data-target="#exampleModalCenter" style="line-height: 1"><i
    ...
    %{--            <-----------------------------NAVBAR USER---------------------------->--}%
        ...
        <div class="dropdown" style="display: inline-flex">
            <button class="btn" style="color: white;font-size: 20px;display: inline-grid" type="button"
                ...
                <div class="nav-link"
                     style="font-size: 16px;position:relative;bottom: 4px"><b>@${session.userUserName}</b><i
        ...
        <div class="d-none">
            <a href="javascript:void(0)" class="hamburger" data-toggle="modal" data-target="#navigation">
                <i class="fa fa-bars fa-2x" style="color: white;position:relative;top: 17px"></i>
            </a>
        </div>

        <div class="modal right fade show" id="navigation" style="display: none;">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-body" id="model-menu">
                        <ul>
                            <li class="model-line"><a href="#" class="menu-link">Create Topic</a></li>
                            <li class="model-line"><a href="#" class="menu-link">Share Document</a></li>
                            <li class="model-line"><a href="#" class="menu-link">Share Link</a></li>
                            <li class="model-line"><a href="#" class="menu-link">Send Invite</a></li>
                            <li class="model-line"><a href="#" class="menu-link">User Info</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    %{--        <------------------------------------NAVBAR SEARCH------------------------------->--}%
    <div class="col-lg-4" style="position:relative;left: 83px">
%{--    <form class="form-inline">--}%
%{--        <label class="sr-only" for="searchText"></label>--}%
%{--        <input type="search" class="form-control mb-2 mr-sm-2" id="searchText" placeholder="Search"--}%
%{--               name="searchText" autocomplete="off">--}%


%{--        <button type="submit" class="btn btn-secondary mb-2">Submit</button>--}%
%{--    </form>--}%
        <g:form url="[controller: 'topic', action: 'search']" class="form-inline">
